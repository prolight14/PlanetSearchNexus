...
export default class SpaceStarScene extends Phaser.Scene
{
    ...
    })
    {
        ...
        this.playScene = this.scene.get("play") as PlayScene;
    ...
    public update()
    {  
        let mainCam = this.playScene.cameras.main;
        ...
        this.csStars.setFollow(
            mainCam.scrollX * this.starScroll - this.subScrollX,  
            mainCam.scrollY * this.starScroll - this.subScrollY
        );
